...
public class NiandulirunController {
    ...
    public R delete(@RequestBody Long[] ids){
        niandulirunService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<NiandulirunEntity> wrapper = new EntityWrapper<NiandulirunEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = niandulirunService.selectCount(wrapper);
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<NiandulirunEntity> ew = new EntityWrapper<NiandulirunEntity>();
        List<Map<String, Object>> result = niandulirunService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<NiandulirunEntity> ew = new EntityWrapper<NiandulirunEntity>();
        List<Map<String, Object>> result = niandulirunService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<NiandulirunEntity> ew = new EntityWrapper<NiandulirunEntity>();
        List<Map<String, Object>> result = niandulirunService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
