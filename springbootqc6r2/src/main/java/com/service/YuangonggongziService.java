...
public interface YuangonggongziService extends IService<YuangonggongziEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<YuangonggongziEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<YuangonggongziEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<YuangonggongziEntity> wrapper);
}
